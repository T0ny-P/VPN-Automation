...
class ExcelJSON(object):
	...
	def createJSON(self):
		...
		###Add in a switch to allow filtered rows and cols
		#mydata = mydata.iloc[[0,1,6,7],0:4]
		...
		#mydata = data.iloc[[0,1,5,7], colStart:False]
		print(mydata)
...
print("\n\nexample4:\n-----------------------------\n")
example4 = ExcelJSON("test.xlsx", "A1:C10", index="A")
example4.icols("A,C")
example4.createJSON()
...
#x = ExcelJSON(r"C:\Users\aprayor\Documents\Gen.IT\WestSafetyServices_VPN_V5.10.xlsm", "B2:D200", sheet="Data-Input Details")
#x.irows("")
#x.icols("B,D")
#x.createJSON()
